  ...
  <div class="mx-3 p-4 bg-white rounded-lg border border-gray-300 max-w-5xl">
    ...
    <div class="flex mb-6 gap-10">
      ...
      <div>
        ...
        <div v-if="social === null || social === '' || !social">
          <p class="text-gray-600">Not available</p>
        </div>
        <div v-else>
          <div class="flex justify-between items-center space-x-2">
            <a href="#" class="px-4 py-2 flex items-center space-x-2 text-black bg-orange-100 rounded-lg hover:bg-orange-200 transition-all">
    ...
    <div v-if="jobsOpening === null || jobsOpening === '' || !jobsOpening" class="border rounded-lg shadow-md p-4 bg-white w-full text-center">
...
export default {
  name: 'SMEProfileDetailComponent',
  data() {
    return {
      smeID: '',
      email: '',
      ...
      jobsOpening: null,
      companyLogo: '/public/assets/img/store-logo.png',
      location: 'Jakarta, Indonesia'
    };
  },
  computed: {
    statusClass() {
      return this.activeStatus ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800';
    }
  },
  mounted() {
    ...
    async fetchSMEProfile() {
      try {
        ...
        this.smeType = {
          ...
          SMETypeName: data.SMEType.SMETypeName || 'N/A',
          SMETypeDescription: data.SMEType.SMETypeDescription || 'N/A',
        };
        this.jobsOpening = data.JobsOpening;
      } catch (error) {
