<template>
    <div class="p-6 bg-white rounded-lg border border-gray-300 flex-1 shadow-sm">
      <div class="flex flex-col lg:flex-row items-start lg:items-center mb-6">
        <img :src="talent.image" alt="Talent Image" class="w-32 h-32 rounded-md object-cover mr-6">
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-600 leading-relaxed">{{ talent.bio }}</p>
      </div>
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-wrap">
          <span
            ...
            :key="skill"
            class="bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-sm mr-2 mb-2"
          >
            {{ skill }}
          </span>
        </div>
      ...
      <div class="mb-6">
        ...
        <ul class="text-black space-y-2">
          <li class="flex items-center">
            ...
            <h2 class="font-semibold text-gray-600 mr-2">Location:</h2> {{ talent.location }}
          </li>
          <li class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-orange-500 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            </svg>
            <h2 class="font-semibold text-gray-600 mr-2">Availability:</h2> {{ talent.availability }}
          </li>
          <li class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-orange-500 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <li class="flex items-center">
            ...
            <h2 class="font-semibold text-gray-600 mr-2">Expected Wage:</h2> {{ talent.price }}
          </li>
        </ul>
      </div>
